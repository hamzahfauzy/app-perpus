        ...
        <div class="panel-header bg-primary-gradient">
            <div class="page-inner py-5">
                <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                    <div>
                        <h2 class="text-white pb-2 fw-bold">Detail Buku : <?=$data->title?></h2>
                        <h5 class="text-white op-7 mb-2">Memanajemen data buku</h5>
                    </div>
                    <div class="ml-md-auto py-2 py-md-0">
                        <a href="index.php?r=books/edit&id=<?=$data->id?>" class="btn btn-secondary btn-round">Edit</a>
                        ...
                        <div class="card-body">
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    <td>Penerbit</td>
                                    <td>:</td>
                                    <td><?=$data->publisher .' ('. $data->publish_year.')'?></td>
                                </tr>
                                <tr>
                                    <td>Kategori</td>
                                    <td>:</td>
